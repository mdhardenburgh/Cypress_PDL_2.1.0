...
InterruptVector:
  ...
  .word EXTBUS_ERR_GDC_SDRAM_IRQHandler		/* IRQ #49 */
  ...
  .word GDC_CMD_SEQ_IRQHandler		/* IRQ #92 */
  .word GDC_BLT_ENG_IRQHandler		/* IRQ #93 */
  .word GDC_DRW_ENG_IRQHandler		/* IRQ #94 */
  .word GDC_CONT_STRM0_IRQHandler		/* IRQ #95 */
  .word GDC_SAFE_STRM0_IRQHandler		/* IRQ #96 */
  .word GDC_DISP_STRM0_IRQHandler		/* IRQ #97 */
  .word GDC_SIGNA0_IRQHandler		/* IRQ #98 */
  .word GDC_DISP0_SYNC0_IRQHandler		/* IRQ #99 */
  .word GDC_DISP0_SYNC1_IRQHandler		/* IRQ #100 */
  .word GDC_CONT_STRM1_IRQHandler		/* IRQ #101 */
  .word GDC_SAFE_STRM1_IRQHandler		/* IRQ #102 */
  .word GDC_DISP_STRM1_IRQHandler		/* IRQ #103 */
  .word GDC_SIGNA1_IRQHandler		/* IRQ #104 */
  .word GDC_DISP1_SYNC0_IRQHandler		/* IRQ #105 */
  .word GDC_DISP1_SYNC1_IRQHandler		/* IRQ #106 */
  .word GDC_CAP_PLN0_IRQHandler		/* IRQ #107 */
  .word GDC_DISP_PLN0_IRQHandler		/* IRQ #108 */
  .word GDC_STRG_STRM0_IRQHandler		/* IRQ #109 */
  .word GDC_HISTGRM_IRQHandler		/* IRQ #110 */
  .word Default_Handler		/* IRQ #111 */
  ...
  .word Default_Handler		/* IRQ #118 */
  .word FLASHIF_IRQHandler		/* IRQ #119 */
  .word GDC_HSSPI_RX_IRQHandler		/* IRQ #120 */
  .word GDC_HSSPI_TX_IRQHandler		/* IRQ #121 */
  .word GDC_HSSPI_FAULT_IRQHandler		/* IRQ #122 */
  .word GDC_HYPERBUS_IRQHandler		/* IRQ #123 */
...
/* IRQ #49 */
  .weak EXTBUS_ERR_GDC_SDRAM_IRQHandler
  .thumb_set EXTBUS_ERR_GDC_SDRAM_IRQHandler, Default_Handler
...
/* IRQ #92 */
  .weak GDC_CMD_SEQ_IRQHandler
  .thumb_set GDC_CMD_SEQ_IRQHandler, Default_Handler

/* IRQ #93 */
  .weak GDC_BLT_ENG_IRQHandler
  .thumb_set GDC_BLT_ENG_IRQHandler, Default_Handler

/* IRQ #94 */
  .weak GDC_DRW_ENG_IRQHandler
  .thumb_set GDC_DRW_ENG_IRQHandler, Default_Handler

/* IRQ #95 */
  .weak GDC_CONT_STRM0_IRQHandler
  .thumb_set GDC_CONT_STRM0_IRQHandler, Default_Handler

/* IRQ #96 */
  .weak GDC_SAFE_STRM0_IRQHandler
  .thumb_set GDC_SAFE_STRM0_IRQHandler, Default_Handler

/* IRQ #97 */
  .weak GDC_DISP_STRM0_IRQHandler
  .thumb_set GDC_DISP_STRM0_IRQHandler, Default_Handler

/* IRQ #98 */
  .weak GDC_SIGNA0_IRQHandler
  .thumb_set GDC_SIGNA0_IRQHandler, Default_Handler

/* IRQ #99 */
  .weak GDC_DISP0_SYNC0_IRQHandler
  .thumb_set GDC_DISP0_SYNC0_IRQHandler, Default_Handler

/* IRQ #100 */
  .weak GDC_DISP0_SYNC1_IRQHandler
  .thumb_set GDC_DISP0_SYNC1_IRQHandler, Default_Handler

/* IRQ #101 */
  .weak GDC_CONT_STRM1_IRQHandler
  .thumb_set GDC_CONT_STRM1_IRQHandler, Default_Handler

/* IRQ #102 */
  .weak GDC_SAFE_STRM1_IRQHandler
  .thumb_set GDC_SAFE_STRM1_IRQHandler, Default_Handler

/* IRQ #103 */
  .weak GDC_DISP_STRM1_IRQHandler
  .thumb_set GDC_DISP_STRM1_IRQHandler, Default_Handler

/* IRQ #104 */
  .weak GDC_SIGNA1_IRQHandler
  .thumb_set GDC_SIGNA1_IRQHandler, Default_Handler

/* IRQ #105 */
  .weak GDC_DISP1_SYNC0_IRQHandler
  .thumb_set GDC_DISP1_SYNC0_IRQHandler, Default_Handler

/* IRQ #106 */
  .weak GDC_DISP1_SYNC1_IRQHandler
  .thumb_set GDC_DISP1_SYNC1_IRQHandler, Default_Handler

/* IRQ #107 */
  .weak GDC_CAP_PLN0_IRQHandler
  .thumb_set GDC_CAP_PLN0_IRQHandler, Default_Handler

/* IRQ #108 */
  .weak GDC_DISP_PLN0_IRQHandler
  .thumb_set GDC_DISP_PLN0_IRQHandler, Default_Handler

/* IRQ #109 */
  .weak GDC_STRG_STRM0_IRQHandler
  .thumb_set GDC_STRG_STRM0_IRQHandler, Default_Handler

/* IRQ #110 */
  .weak GDC_HISTGRM_IRQHandler
  .thumb_set GDC_HISTGRM_IRQHandler, Default_Handler
...
/* IRQ #120 */
  .weak GDC_HSSPI_RX_IRQHandler
  .thumb_set GDC_HSSPI_RX_IRQHandler, Default_Handler

/* IRQ #121 */
  .weak GDC_HSSPI_TX_IRQHandler
  .thumb_set GDC_HSSPI_TX_IRQHandler, Default_Handler

/* IRQ #122 */
  .weak GDC_HSSPI_FAULT_IRQHandler
  .thumb_set GDC_HSSPI_FAULT_IRQHandler, Default_Handler

/* IRQ #123 */
  .weak GDC_HYPERBUS_IRQHandler
  .thumb_set GDC_HYPERBUS_IRQHandler, Default_Handler
