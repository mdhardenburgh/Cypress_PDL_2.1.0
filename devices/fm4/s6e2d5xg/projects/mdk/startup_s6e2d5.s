...
; Numbered IRQ handler vectors				
                ...
                DCD     EXTBUS_ERR_GDC_SDRAM_IRQHandler		; IRQ #49
                ...
                DCD     GDC_CMD_SEQ_IRQHandler		; IRQ #92
                DCD     GDC_BLT_ENG_IRQHandler		; IRQ #93
                DCD     GDC_DRW_ENG_IRQHandler		; IRQ #94
                DCD     GDC_CONT_STRM0_IRQHandler		; IRQ #95
                DCD     GDC_SAFE_STRM0_IRQHandler		; IRQ #96
                DCD     GDC_DISP_STRM0_IRQHandler		; IRQ #97
                DCD     GDC_SIGNA0_IRQHandler		; IRQ #98
                DCD     GDC_DISP0_SYNC0_IRQHandler		; IRQ #99
                DCD     GDC_DISP0_SYNC1_IRQHandler		; IRQ #100
                DCD     GDC_CONT_STRM1_IRQHandler		; IRQ #101
                DCD     GDC_SAFE_STRM1_IRQHandler		; IRQ #102
                DCD     GDC_DISP_STRM1_IRQHandler		; IRQ #103
                DCD     GDC_SIGNA1_IRQHandler		; IRQ #104
                DCD     GDC_DISP1_SYNC0_IRQHandler		; IRQ #105
                DCD     GDC_DISP1_SYNC1_IRQHandler		; IRQ #106
                DCD     GDC_CAP_PLN0_IRQHandler		; IRQ #107
                DCD     GDC_DISP_PLN0_IRQHandler		; IRQ #108
                DCD     GDC_STRG_STRM0_IRQHandler		; IRQ #109
                DCD     GDC_HISTGRM_IRQHandler		; IRQ #110
                DCD     Dummy		; IRQ #111
                ...
                DCD     GDC_HSSPI_RX_IRQHandler		; IRQ #120
                DCD     GDC_HSSPI_TX_IRQHandler		; IRQ #121
                DCD     GDC_HSSPI_FAULT_IRQHandler		; IRQ #122
                DCD     GDC_HYPERBUS_IRQHandler		; IRQ #123
...
Default_Handler PROC
                ...
                EXPORT  EXTBUS_ERR_GDC_SDRAM_IRQHandler    [WEAK]
                ...
                EXPORT  GDC_CMD_SEQ_IRQHandler    [WEAK]
                EXPORT  GDC_BLT_ENG_IRQHandler    [WEAK]
                EXPORT  GDC_DRW_ENG_IRQHandler    [WEAK]
                EXPORT  GDC_CONT_STRM0_IRQHandler    [WEAK]
                EXPORT  GDC_SAFE_STRM0_IRQHandler    [WEAK]
                EXPORT  GDC_DISP_STRM0_IRQHandler    [WEAK]
                EXPORT  GDC_SIGNA0_IRQHandler    [WEAK]
                EXPORT  GDC_DISP0_SYNC0_IRQHandler    [WEAK]
                EXPORT  GDC_DISP0_SYNC1_IRQHandler    [WEAK]
                EXPORT  GDC_CONT_STRM1_IRQHandler    [WEAK]
                EXPORT  GDC_SAFE_STRM1_IRQHandler    [WEAK]
                EXPORT  GDC_DISP_STRM1_IRQHandler    [WEAK]
                EXPORT  GDC_SIGNA1_IRQHandler    [WEAK]
                EXPORT  GDC_DISP1_SYNC0_IRQHandler    [WEAK]
                EXPORT  GDC_DISP1_SYNC1_IRQHandler    [WEAK]
                EXPORT  GDC_CAP_PLN0_IRQHandler    [WEAK]
                EXPORT  GDC_DISP_PLN0_IRQHandler    [WEAK]
                EXPORT  GDC_STRG_STRM0_IRQHandler    [WEAK]
                EXPORT  GDC_HISTGRM_IRQHandler    [WEAK]
                EXPORT  DSTC_HW_IRQHandler    [WEAK]
                EXPORT  PCRC_I2S0_1_IRQHandler    [WEAK]
                EXPORT  FLASHIF_IRQHandler    [WEAK]
                EXPORT  GDC_HSSPI_RX_IRQHandler    [WEAK]
                EXPORT  GDC_HSSPI_TX_IRQHandler    [WEAK]
                EXPORT  GDC_HSSPI_FAULT_IRQHandler    [WEAK]
                EXPORT  GDC_HYPERBUS_IRQHandler    [WEAK]
...
EXTBUS_ERR_GDC_SDRAM_IRQHandler		; IRQ #49
...
GDC_CMD_SEQ_IRQHandler		; IRQ #92
GDC_BLT_ENG_IRQHandler		; IRQ #93
GDC_DRW_ENG_IRQHandler		; IRQ #94
GDC_CONT_STRM0_IRQHandler		; IRQ #95
GDC_SAFE_STRM0_IRQHandler		; IRQ #96
GDC_DISP_STRM0_IRQHandler		; IRQ #97
GDC_SIGNA0_IRQHandler		; IRQ #98
GDC_DISP0_SYNC0_IRQHandler		; IRQ #99
GDC_DISP0_SYNC1_IRQHandler		; IRQ #100
GDC_CONT_STRM1_IRQHandler		; IRQ #101
GDC_SAFE_STRM1_IRQHandler		; IRQ #102
GDC_DISP_STRM1_IRQHandler		; IRQ #103
GDC_SIGNA1_IRQHandler		; IRQ #104
GDC_DISP1_SYNC0_IRQHandler		; IRQ #105
GDC_DISP1_SYNC1_IRQHandler		; IRQ #106
GDC_CAP_PLN0_IRQHandler		; IRQ #107
GDC_DISP_PLN0_IRQHandler		; IRQ #108
GDC_STRG_STRM0_IRQHandler		; IRQ #109
GDC_HISTGRM_IRQHandler		; IRQ #110
DSTC_HW_IRQHandler		; IRQ #112
PCRC_I2S0_1_IRQHandler		; IRQ #117
FLASHIF_IRQHandler		; IRQ #119
GDC_HSSPI_RX_IRQHandler		; IRQ #120
GDC_HSSPI_TX_IRQHandler		; IRQ #121
GDC_HSSPI_FAULT_IRQHandler		; IRQ #122
GDC_HYPERBUS_IRQHandler		; IRQ #123
