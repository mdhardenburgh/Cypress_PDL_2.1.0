...
You can see that the MCU is in normal run mode when the LED (P18) is blinking. 
...
event is triggered by inputting low to WKUP0. WKUP0 must be pulled up before 
using this example.
