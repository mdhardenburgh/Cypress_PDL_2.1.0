...
/******************************************************************************/
#if !defined(SetPinFunc_SOT6_1) || !defined(SetPinFunc_SCK6_1)
#error SOT6_1 or SCK6_1 is not available on this product, please use other \
...
/******************************************************************************/
volatile stc_mfsn_i2c_t* I2cCh = &I2C6;
