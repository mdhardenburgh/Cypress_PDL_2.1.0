...
version          1.10
================================================================================
This example demonstrates communication between CSIO6 and CSIO7 with 
interrupt mode
================================================================================
...
This example demonstrates the communication between CSIO6 and CSIO7 with 
interrupt mode. CSIO6 as Master and CSIO7 as Slave, at first Master 
...
* Run the code
* Check the the Master transfer buffer array and the Slave receive buffer array
