...
This sample demonstrates the communication between CSIO6 and CSIO7 with polling mode.
CSIO6 as  a Master and CSIO7 as a Slave, at first the Master sends data to 
the Slave and then the Master reads data from the Slave.
