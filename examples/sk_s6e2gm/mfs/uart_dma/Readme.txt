...
version          1.10
================================================================================
This example demonstrates the communication between UART3 and UART6 with 
...
This example demonstrates communication between UART3 and UART6 with
interrupt mode using DMA. The SOT3_1 should be connected with SIN6_1 before 
using this example.
...
* Connect SOT3_1 with SIN6_1
* Run the code
* Break 
* Check the TX buffer(au8UartTxBuf) and RX buffer(au8UartRxBuf)
* Run terminal with a speed 115200 baud to observe the I/O data  
