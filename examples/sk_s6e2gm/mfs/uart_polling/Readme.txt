...
version          1.10
================================================================================
This example demonstrates the communication between UART3 and UART9
================================================================================
...
This example demonstrates communication between UART3 and UART9 with 
polling mode. 
The SOT3_1 should be connected with SIN9_1 before using this example.
