...
* Run the code
* Watch the Terminal I/O window(Debug window). There should be displayed the unique ID of the
  your device in decimal and hexadecimal form
