...
This example demonstrates the PPG function of the Base Timer in both the interrupt and 
polling access modes of the PWM timer. 
The PPG wave can be observed at P40 during the demonstration process.
================================================================================
How To Use This Code Example 

* Rebuild and run the program.  
* Watch the Terminal I/O window (Debug viewer). The PPG wave can be observed at 
   P40/TIOA0_0 synchronously.
