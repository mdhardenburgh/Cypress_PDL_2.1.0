...
Description:
================================================================================
This example sets the ADC0 channel 17 in single conversion mode and fetches
...
* Check the output value in terminal I/O to see whether it is appropriate to illumination 
