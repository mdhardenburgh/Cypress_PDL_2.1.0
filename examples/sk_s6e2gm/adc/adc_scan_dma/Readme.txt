...
version          1.10
================================================================================
This example samples a single channel of ADC with DMA transfer.
================================================================================
...
This example samples an ADC channel using DMA under these conditions.
...
* Run the code.
* Run a terminal with a speed 115200 baud to observe I/O data.
* Check the output value in the terminal I/O to see whether it is appropriate to illumination 
  intensity of onboard phototransistor from 0 to 4095.
