...
This example demonstrates the RT-PPG mode of the waveform generator PPG0 
connected to WFG10
...
* Open the Terminal I/O window (Debug window), observe display information, and
  use an oscillograph to observe the RTO10_0 and RTO11_0 output wave
