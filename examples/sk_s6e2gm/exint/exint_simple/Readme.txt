...
INT06_1 input is set to falling edge and the dedicated callback function 
counts the events. 
INT08_0 input is set to rising edge and the dedicated callback function counts
the events.
...
* Pull-up INT06_1 and NMIX, pull-down INT08_0.
* Run the project.
* Connect INT06_1 to GND.
* Check whether External Interrupt 0 occurs by watching the variable "u32ExtInt6Count"
* Connect INT08_0 to VCC.
