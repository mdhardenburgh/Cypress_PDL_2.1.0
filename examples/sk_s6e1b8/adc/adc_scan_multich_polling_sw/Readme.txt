...
This example samples multi channels of ADC in polling mode. The ADC0 channel 0 
and channel 19 are set to single conversion mode. A software trigger starts the conversion. 
...
* Connect a regulated DC power supply: AN00 to V+ of the DC source, AVSS to 
  V- of the DC source .
* Turn on the DC power.
* Run the code.
* Run the terminal with a speed of 115200 baud to observe I/O data.
* Check the output value in the terminal I/O to see whether it is equal to DC power and 
