...
version          1.10
================================================================================
This example demonstrates the RT-PPG mode of the MFT WFG module
================================================================================
...
This example demonstrates the RT-PPG mode of the waveform generator PPG0 connected 
to WFG10
...
* Open the Terminal I/O window (Debug window), observe display information, and use an oscillograph to 
  observe the RTO00_0 and RTO01_0 output wave
