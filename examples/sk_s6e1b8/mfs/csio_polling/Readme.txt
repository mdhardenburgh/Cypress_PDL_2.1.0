...
This sample demonstrates the communication between CSIO0 and CSIO1 with polling mode.
CSIO0 is  the master and CSIO1 is the slave. First, the master sends data to 
