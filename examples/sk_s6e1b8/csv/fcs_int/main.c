...
* \version          1.10
*
* \brief     This example demonstrates FCS (Anomalous Frequency Detection) interrupt when Main clock  frequency is abnormal
*
*
********************************************************************************
* \copyright
...
{        
    ...
    if(TRUE == bAnomalousFrequency)
    {
        while(1)
		{
			/* Anomalous Frequency reset is generated */
		}
    }
