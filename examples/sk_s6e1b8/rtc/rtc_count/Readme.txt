...
second the time and date are read, and when the alarm occurs, an LED 
starts blinking.
...
* Open the terminal.
  ...
  second, the RTC operates normally.
* After 1 minute, P3D (Red LED) outputs HIGH and LOW for every 0.5
