...
This example demonstrates the PWM function of the Base Timer in both interrupt and 
polling access modes of the PWM timer. 
The PWM wave can be observed at P3A during demonstration process.
================================================================================
How To Use This Code Example 

* Rebuild and run the program.  
* Watch the Terminal I/O window (Debug viewer), and observe the PWM wave at 
   P3A/TIOA0_1 synchronously.
